define([
  ...
  function DashboardViewModel() {
    ...
    self.updateViewModelData = function (data) {
      self.currentWeather.temp(formatWithUnit(data.current.temp, ' °C'));
      self.currentWeather.feels_like(formatWithUnit(data.current.feels_like, ' °C'));
      self.currentWeather.pressure(formatWithUnit(data.current.pressure, ' hPa'));
      self.currentWeather.humidity(formatWithUnit(data.current.humidity, ' %'));
      self.currentWeather.wind_speed(formatWithUnit(data.current.wind_speed, ' m/s'));
      self.currentWeather.wind_deg(formatWithUnit(data.current.wind_deg, ' °'));
      self.currentWeather.wind_gust(formatWithUnit(data.current.wind_gust, ' m/s'));
      self.currentWeather.description(data.current.weather[0].description);
      self.currentWeather.icon(`http://openweathermap.org/img/wn/${data.current.weather[0].icon}.png`);
  };
    ...
    self.updateForecastData = function (data) {
      ...
      self.forecastWeather.tempAvg(formatWithUnit(tempAvg.toFixed(2), ' °C'));
      self.forecastWeather.feelsLikeAvg(formatWithUnit(feelsLikeAvg.toFixed(2),' °C'));
      self.forecastWeather.pressure(formatWithUnit(today.pressure, ' hPa'));
      self.forecastWeather.humidity(formatWithUnit(today.humidity, ' %'));
      self.forecastWeather.wind_speed(formatWithUnit(today.wind_speed, ' m/s'));
      self.forecastWeather.wind_deg(formatWithUnit(today.wind_deg, ' °'));
      self.forecastWeather.wind_gust(formatWithUnit(today.wind_gust, ' m/s'));
  ...
  self.updateSelectedDateWeather = function (selectedDateData) {
    ...
    self.forecastWeatherByDate.tempAvg(formatWithUnit(tempAvg.toFixed(2), ' °C'));
    self.forecastWeatherByDate.feelsLikeAvg(formatWithUnit(feelsLikeAvg.toFixed(2),' °C'));
    self.forecastWeatherByDate.pressure(formatWithUnit(selectedDateData.pressure, ' hPa'));
    self.forecastWeatherByDate.humidity(formatWithUnit(selectedDateData.humidity, ' %'));
    self.forecastWeatherByDate.wind_speed(formatWithUnit(selectedDateData.wind_speed, ' m/s'));
    self.forecastWeatherByDate.wind_deg(formatWithUnit(selectedDateData.wind_deg, ' °'));
    self.forecastWeatherByDate.wind_gust(formatWithUnit(selectedDateData.wind_gust, ' m/s'));
    self.forecastWeatherByDate.description(selectedDateData.weather[0].description);
    self.forecastWeatherByDate.icon(`http://openweathermap.org/img/wn/${selectedDateData.weather[0].icon}.png`);
};
